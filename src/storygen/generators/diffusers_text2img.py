    ...
    def _generate_scene_text2img(self, request: GenerationRequest) -> GenerationCandidate:
        ...
        return GenerationCandidate(
            ...
            metadata={
                ...
                "action_critical": request.extra_options.get("action_critical"),
                "scene_visual_plan": request.extra_options.get("scene_visual_plan"),
    ...
    def _apply_ip_adapter_if_requested(
        ...
        *,
        ...
        return {
            ...
            "ip_adapter_scale_reason": request.extra_options.get("ip_adapter_scale_reason"),
            "identity_anchor_subject_type": request.extra_options.get("identity_anchor_subject_type"),
