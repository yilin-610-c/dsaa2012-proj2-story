    ...
    def _generate_scene_text2img(self, request: GenerationRequest) -> GenerationCandidate:
        ...
        return GenerationCandidate(
            ...
            metadata={
                ...
                "route_hint_adjustment_reason": request.extra_options.get("route_hint_adjustment_reason"),
                ...
                "interaction_summary": request.extra_options.get("interaction_summary"),
                "spatial_relation": request.extra_options.get("spatial_relation"),
                "framing": request.extra_options.get("framing"),
                "setting_focus": request.extra_options.get("setting_focus"),
                "visible_character_count": request.extra_options.get("visible_character_count"),
                "scene_focus_mode": request.extra_options.get("scene_focus_mode"),
                **identity_metadata,
            },
        )
